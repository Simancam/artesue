...
export default function Dashboard() {
  ...
  // Usar los datos del archivo JSON
  const estates: Estate[] = estatesData.estates
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Panel de Control de Inmobiliaria</h1>
