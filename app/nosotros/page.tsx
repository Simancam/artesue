  ...
  return (
    <div ref={containerRef}>
      ...
      <div className="relative h-screen overflow-hidden">
        <Banner
          imageUrl="https://www.activa.cl/wp-content/uploads/2020/11/Administracion-de-propiedades.jpg"
          height="100vh"
        >
          <div className="flex flex-col items-center justify-center h-full text-center px-4 relative z-10">
            ...
            >
              Somos un equipo apasionado por ayudarte a encontrar tu hogar
              ideal.
            </motion.p>
          </div>
        </Banner>
      ...
      <section className="min-h-screen bg-white flex items-center relative">
        <div className="w-full px-6 py-20">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              style={{ y }}
              className="flex justify-center relative w-full aspect-[16/9] order-2 lg:order-1"
            >
              <Image
      ...
      {/* Philosophy Section with gradient background */}
